...
const faqs: FaqItem[] = [
  {
    q: "What does an alternating case converter do?",
    a: "An alternating case converter switches letter casing in a predictable pattern (upper, lower, upper, lower) while preserving punctuation, numbers, and line breaks. It is a formatting effect, not a writing or grammar tool.",
  },
  {
    q: "Why is there only one textarea?",
    a: "This page uses a single editor for both input and output. After you convert, the editor contains the alternating-case result, which is the exact text you copy or download. It keeps the workflow simple and avoids mismatched input vs. output boxes.",
  },
  {
    q: "Does it change punctuation, line breaks, or whitespace?",
    a: "No. The converter only changes letter casing on letters. Line breaks, tabs, multiple spaces, punctuation, emojis, and numbers remain exactly as they were in your input.",
  },
  {
  ...
  {
    q: "What does \"Ignore spaces\" do?",
    a: "With Ignore spaces enabled, spaces do not affect the alternating pattern and only letters advance the sequence. If you turn it off, regular spaces count as steps in the pattern, which can shift which letters end up uppercase vs. lowercase across word boundaries.",
  },
  {
