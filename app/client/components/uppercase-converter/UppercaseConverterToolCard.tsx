...
import { toUppercase } from "./uppercaseTransforms";

type UppercaseConverterToolCardProps = {
  input: string;
  setInput: (v: string) => void;
};

export function UppercaseConverterToolCard({
  input,
  setInput,
}: UppercaseConverterToolCardProps) {
