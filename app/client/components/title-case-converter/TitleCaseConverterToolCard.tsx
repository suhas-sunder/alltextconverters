...
import { toTitleCaseSimple } from "./titleCaseTransforms";

type TitleCaseConverterToolCardProps = {
  input: string;
  setInput: (v: string) => void;
};

export function TitleCaseConverterToolCard({
  input,
  setInput,
}: TitleCaseConverterToolCardProps) {
  ...
  function convertToTitleCase() {
    setErrorMsg(null);
    setInfoMsg(null);
    setInput(toTitleCaseSimple(input));
  }
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      if (ext === "pdf") {
        ...
        setInput(toTitleCaseSimple(cleaned));
